...
export function Toggle({ className = '', checked, onChange, ...rest }: ToggleProps & ComponentPropsWithRef<'label'>) {
  return (
    <label className={`relative inline-flex items-center cursor-pointer ${className}`} {...rest}>
